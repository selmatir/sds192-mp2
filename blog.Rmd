...
plotscale <- function(X) {
        ...
        scale_shape_discrete(name = "election's outcome") +
        scale_color_manual(labels = c("DEM", "REP"), values = c("#0006CC", "#CC0000")) +
        scale_x_continuous(limits=c(0,220000), breaks=c(0,100000,200000), labels = c("0","100","200")) +
        scale_y_continuous(limits=c(0,X), breaks=c(0,250000,500000,750000,1000000), labels=c("0","0.25","0.5","0.75", "1")) +
...
The number of votes and amount of contribution variables have been mapped to the visual dimension position using a scatterplot. Another layer of information concerning the party of the candidate has been mapped to the visual dimension color and the outcome of th election has been mapped to the visual dimension shape. 
